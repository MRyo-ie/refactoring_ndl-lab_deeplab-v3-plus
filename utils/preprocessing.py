...
# # colour map
# _label_colours = [(0, 0, 0),  # 0=background
...
def decode_labels(mask, num_images=1, num_classes=21, label_colours=None):
  ...
  ###  クラス色の設定  ###
  # 0 ~ 255  3次元
  label_colours = label_colormap(num_classes)    # 0=background
  #   print('[Info] label_colours len : ', len(label_colours))
  #   print('[Info] label_colours : ', label_colours)
